...
<div id="o-header-2013">
    <div class="w" id="header-2013">
        <div id="logo-2013" class="ld"><a href="/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img
                src="/images/convenient-logo.gif" width="270" height="60" alt="良品购"></a></div>
        <!--logo end-->
        <div id="search-2013">
        ...
        <div id="my360buy-2013">
            <dl>
                <dt class="ld"><s></s><a href="http://sso.convenientbug.com/user/showLogin"
                                         clstag="homepage|keycount|home2012|04a">我的良品购</a><b></b></dt>
                <dd>
