...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/convenient-logo.gif" alt="良品购商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
    ...
    <input type="hidden" name="orderShipping.receiverName" value="良品购"/>
    <input type="hidden" name="orderShipping.receiverMobile" value="13800008888"/>
                                ...
                                <div class="shopping-lists" id="shopping-lists">
                                    <div class="shopping-list ABTest">
                                        <div class="goods-list">
                                            <!--配送方式-->
                                            <h4 class="vendor_name_h" id="0">商家：良品购商城</h4>
                                                    ...
                                                    <ul>
                                                        <li class="mode-tab-item " id="jd_shipment_item"
                                                            onclick="doSwithTab('pay')"><span
                                                                id="jdShip-span-tip" class="m-txt">良品购快递<i
                                                                class='qmark-icon qmark-tip'
                                                                data-tips='由良品购公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <div class="sticky-wrap">
                            <div class="inner">
                                ...
                                <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
                                    部分商品货到付款方式：先由良品购配送“提货单”并收款，然后厂商发货。
                                </div>
                            </div>
