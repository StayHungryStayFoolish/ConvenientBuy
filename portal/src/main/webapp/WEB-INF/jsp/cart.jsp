...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/convenient-logo.gif"
                                    title="返回良品购商城首页" alt="返回良品购商城首页"></a></div>
    ...
    <div id="show">
        ...
        <div class="cart-inner">
            <div class="cart-thead clearfix">
                ...
                <div class="column t-price">良品购价</div>
              ...
              <span class="column t-checkbox form">
                  ...
                  <span class="check-comm-btns" id="checkout-jd">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOrder();" class="checkout-jd">去良品购结算<b></b></a>
                      </span>
                  </span>
                        </div>
                        <div class="total fr">
